...
public class LogRequester extends APIAccountRequester {
    ...
    /**
     * Creates a LogRequester with custom logging settings. For most SDK users LogRequesters will be
     ...
     */
    public LogRequester(String credAccountId, String credAuthToken, String actingAccountId, LogWriter writer) throws PersyException {
