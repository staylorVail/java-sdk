...
public class APIRequester {
	 ...
	 * APIRequester.GET(String, HashMap<String,String>). For use with GSON
	 * conversions.
	 **/
	...
	/**
	 * Converts a HashMap<String, String> into a HTTP GET query string to append to a URL.
	 * For example:
	 * mapToQueryString({"key": "value", "key1": "value1"}) -> "?key=value&key1=value1"
	 *
