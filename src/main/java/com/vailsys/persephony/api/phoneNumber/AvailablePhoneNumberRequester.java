...
public class AvailablePhoneNumberRequester extends APIRequester {
    ...
    /**
     * Creates an AvailablePhoneNumberRequester with custom logging settigns. For most SDK users AvailablePhoneNumberRequesters will be
     ...
     */
    public AvailablePhoneNumberRequester(String credAccountId, String credAuthToken, String actingAccountId, LogWriter writer) throws PersyException {
